...
* Hypothesis 1:
  * BitCoin is positively correlated to tech stocks and various macroeconomic factors.
    * Validation requirements:
      * Use correlation analysis to assess relationships
      * Visualise trends using graphs
      * Test consistency against various micro/macroeconomic factors and choose those with the highest impact

* Hypothesis 2:
  * Macroeconomic factors have influence over BitCoin price movements
    * Validation requirements:
      * Test BitCoin prices against macroeconomic factors by using  Correlation and Predictive Power Score (PPS)
      * Choose the most impactful features
      * Train several regression models to evaluate performance
      * Choose the highest performing model that aligns with expectations
